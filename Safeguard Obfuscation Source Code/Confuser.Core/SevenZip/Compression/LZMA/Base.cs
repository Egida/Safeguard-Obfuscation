...
namespace SevenZip.Compression.LZMA
{
	...
	internal abstract class Base
	{
		...
		// Token: 0x0600006C RID: 108 RVA: 0x00002194 File Offset: 0x00000394
		protected Base()
		{
		}
		...
		public struct State
		{
			// Token: 0x0600006D RID: 109 RVA: 0x00002331 File Offset: 0x00000531
			public void Init()
			{
				this.Index = 0U;
			}

			// Token: 0x0600006E RID: 110 RVA: 0x000056B4 File Offset: 0x000038B4
			...
			// Token: 0x0600006F RID: 111 RVA: 0x0000233B File Offset: 0x0000053B
			public void UpdateMatch()
			{
				this.Index = ((this.Index < 7U) ? 7U : 10U);
			}

			// Token: 0x06000070 RID: 112 RVA: 0x00002352 File Offset: 0x00000552
			public void UpdateRep()
			{
				this.Index = ((this.Index < 7U) ? 8U : 11U);
			}

			// Token: 0x06000071 RID: 113 RVA: 0x00002369 File Offset: 0x00000569
			public void UpdateShortRep()
			{
				this.Index = ((this.Index < 7U) ? 9U : 11U);
			}

			// Token: 0x06000072 RID: 114 RVA: 0x00005704 File Offset: 0x00003904

	...
	internal class InjectPhase : ProtectionPhase
	{
		...
		protected override void Execute(ConfuserContext context, ProtectionParameters parameters)
		{
			...
			if (flag)
			{
				...
				moduleCtx.Mode = parameters.GetParameter<Mode>(context, context.CurrentModule, "mode", Mode.x86);
		...
		{
			// Token: 0x06000268 RID: 616 RVA: 0x00004A68 File Offset: 0x00002C68
			public <>c__DisplayClass5_0()
			{
			}

			// Token: 0x06000269 RID: 617 RVA: 0x00014F54 File Offset: 0x00013154
			...
			public InjectPhase.<>c__DisplayClass5_1 CS$<>8__locals1;
		}
		...
		{
			// Token: 0x0600026A RID: 618 RVA: 0x00004A68 File Offset: 0x00002C68

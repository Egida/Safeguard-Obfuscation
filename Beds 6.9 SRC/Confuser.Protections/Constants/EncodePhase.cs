...
namespace Confuser.Protections.Constants
{
	...
	internal class EncodePhase : ProtectionPhase
	{
		...
		private class ByteArrayComparer : IEqualityComparer<byte[]>
		{
			...
			// Token: 0x06000253 RID: 595 RVA: 0x00004A68 File Offset: 0x00002C68
		...
		{
			// Token: 0x06000254 RID: 596 RVA: 0x00004A68 File Offset: 0x00002C68
			public <>c__DisplayClass5_0()
			{
			}

			// Token: 0x06000255 RID: 597 RVA: 0x000144BC File Offset: 0x000126BC
			internal Instruction[] <Execute>b__0(Instruction[] arg)
			{
				List<Instruction> repl = new List<Instruction>();
				repl.AddRange(arg);
				repl.Add(Instruction.Create(OpCodes.Dup));
		...
		{
			// Token: 0x06000256 RID: 598 RVA: 0x00005498 File Offset: 0x00003698
			// Note: this type is marked as 'beforefieldinit'.
			static <>c()
			{
			}

			// Token: 0x06000257 RID: 599 RVA: 0x00004A68 File Offset: 0x00002C68
			public <>c()
			{
			}

			// Token: 0x06000258 RID: 600 RVA: 0x000054A4 File Offset: 0x000036A4
			internal byte <EncodeString>b__6_0(DecoderDesc desc)
			{
				return desc.StringID;
			}

			// Token: 0x06000259 RID: 601 RVA: 0x000054AC File Offset: 0x000036AC
			internal byte <EncodeConstant32>b__7_0(DecoderDesc desc)
			{
				return desc.NumberID;
			}

			// Token: 0x0600025A RID: 602 RVA: 0x000054AC File Offset: 0x000036AC
			internal byte <EncodeConstant64>b__8_0(DecoderDesc desc)
			{
				return desc.NumberID;
			}

			// Token: 0x0600025B RID: 603 RVA: 0x000054B4 File Offset: 0x000036B4
			internal bool <RemoveDataFieldRefs>b__12_0(MethodDef m)
			{
				return m.HasBody;
			}

			// Token: 0x04000199 RID: 409
			public static readonly EncodePhase.<>c <>9 = new EncodePhase.<>c();

			// Token: 0x0400019A RID: 410
			public static Func<DecoderDesc, byte> <>9__6_0;

			// Token: 0x0400019B RID: 411
			public static Func<DecoderDesc, byte> <>9__7_0;

			// Token: 0x0400019C RID: 412
			public static Func<DecoderDesc, byte> <>9__8_0;

			// Token: 0x0400019D RID: 413
			public static Func<MethodDef, bool> <>9__12_0;
		}
		...
		{
			// Token: 0x0600025C RID: 604 RVA: 0x00004A68 File Offset: 0x00002C68
			public <>c__DisplayClass13_0()
			{
			}

			// Token: 0x0600025D RID: 605 RVA: 0x000054BC File Offset: 0x000036BC
			internal bool <ExtractConstants>b__0(Tuple<MethodDef, Instruction> entry)
			{
				return entry.Item2 == this.instrs[this.i - 4];
			}

			// Token: 0x0400019E RID: 414
			public IList<Instruction> instrs;
